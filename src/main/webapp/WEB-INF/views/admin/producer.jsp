		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/producer">Producer<span
...
<div class="row">
	...
	<form:form class="form-horizontal" action="/admin/producer" method="GET" modelAttribute="filter" id="filter">
		<custom:hiddenInputs excludeParams="search,countryIds" />
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				...
				<custom:hiddenInputs excludeParams="name,country"/>
					<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-md-3 col-xs-3">
					<a class="btn btn-warning"
						href="/admin/producer/update/${producer.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-3 col-xs-3">
					<a class="btn btn-danger"
						href="/admin/producer/delete/${producer.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
