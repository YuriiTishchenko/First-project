		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/country">Country<span
	...
	<div class="col-md-7 col-xs-12">
		...
		<c:forEach items="${page.content}" var="country">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/country/update/${country.id}<custom:allParams/>">update</a></div>
